...
public class Menu {
    ...
    public static void sobre() {
        ...
        System.out.println("   Dayana Barbosa  -  day_sbarbosa");
        System.out.println("https://github.com/Day-Barbosa/Projeto_ContaB1ancaria");
        System.out.println("*********************************************************");
    }
    ...
    private static void cadastrarConta() {
        ...
        switch (tipo) {
            ...
            case 2 -> {
                System.out.print("Digite o dia do aniversário da conta poupança: ");
                int aniversario = leia.nextInt();
                contaController.cadastrar(
                    new ContaPoupanca(contaController.gerarNumero(), agencia, aniversario, titular, saldo, aniversario)
                );
            }
