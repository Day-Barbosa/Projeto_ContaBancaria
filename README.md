...
1\. Clone o repositório do Projeto \[Projeto\_ContaBancaria) ](https://github.com/Day-Barbosa/Projeto\_ContaBancaria) dentro da pasta do \*Workspace\* do Eclipse/STS



```bash

git clone https://github.com/Day-Barbosa/Projeto\_ContaBancaria.git
...
7\. Marque o Projeto Projeto\_ContaBancaria no item \*\*Projects\*\* e clique no botão \*\*Finish\*\* para concluir a importação
...
Desenvolvido por \[\*\*Dayana Barbosa\*\*](https://github.com/Day-Barbosa)
